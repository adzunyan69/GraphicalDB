...
void MainWindow::setupQuadraticDemo(QCustomPlot *customPlot)
{
  ...
  customPlot->graph(0)->setScatterStyle(QCPScatterStyle(QPixmap("C:/Users/kruglyakovav/Documents/GraphicalDatabase/qcustomplot/examples/plots/sun.png")));
  customPlot->graph(0)->addData(556, 1);
  customPlot->graph(0)->addData(1376, 1);
  customPlot->graph(0)->addData(2965, 1);
  ...
  QSharedPointer<QCPAxisTickerText> textTicker(new QCPAxisTickerText);
    ...
    textTicker->addTick(998, "1 \n (998)");
    textTicker->addTick(2098, "2 \n (1100)");
    textTicker->addTick(3398, "4 \n (1400)");

    QSharedPointer<QCPAxisTickerText> textTicker2(new QCPAxisTickerText);
    textTicker2->addTick(0, "Вагон");
    textTicker2->addTick(1, "Мосты");
    textTicker2->addTick(2, "Км. \nстолбы");
    customPlot->yAxis->setTicker(textTicker2);
    ...
    infLine->point1->setCoords(1500, 0);  // location of point 1 in plot coordinate
    infLine->point2->setCoords(1500, 1);  // location of point 2 in plot coordinate

    customPlot->addGraph();
    customPlot->graph(1)->setLineStyle(QCPGraph::lsNone);
    customPlot->graph(1)->setScatterStyle(QCPScatterStyle(QPixmap("C:/Users/kruglyakovav/Documents/GraphicalDatabase/qcustomplot/examples/plots/sun.png")));
    customPlot->graph(1)->addData(1500, 0);
...
void MainWindow::setupScatterPixmapDemo(QCustomPlot *customPlot)
{
  ...
  customPlot->axisRect()->setBackground(QPixmap("C:/Users/kruglyakovav/Documents/GraphicalDatabase/qcustomplot/examples/plots/solarpanels.jpg"));
  customPlot->addGraph();
  customPlot->graph()->setLineStyle(QCPGraph::lsLine);
  QPen pen;
  ...
  customPlot->graph()->setScatterStyle(QCPScatterStyle(QPixmap("C:/Users/kruglyakovav/Documents/GraphicalDatabase/qcustomplot/examples/plots/sun.png")));
...
void MainWindow::setupTextureBrushDemo(QCustomPlot *customPlot)
{
  ...
  customPlot->graph(0)->setBrush(QBrush(QPixmap("C:/Users/kruglyakovav/Documents/GraphicalDatabase/qcustomplot/examples/plots/balboa.jpg"))); // fill with texture of specified image
...
void MainWindow::setupMultiAxisDemo(QCustomPlot *customPlot)
{
  ...
  customPlot->addGraph();
  customPlot->graph(1)->setPen(QPen(Qt::red));
  customPlot->graph(1)->setBrush(QBrush(QPixmap("C:/Users/kruglyakovav/Documents/GraphicalDatabase/qcustomplot/examples/plots/balboa.jpg"))); // same fill as we used for graph 0
